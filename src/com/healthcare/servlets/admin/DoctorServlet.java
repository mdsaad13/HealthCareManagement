 ...
 */
@WebServlet("/admin/DoctorServlet")
public class DoctorServlet extends HttpServlet {
	...
	protected void doPost(final HttpServletRequest request, final HttpServletResponse response)
		...
		final Doctor doctor = new Doctor(id, name, email, password, phone, age, address, deptid, qualification, imgUrl);
		final AccountUtil accountUtil = new AccountUtil();

		String Message = "AddFailed";
		if (action.equals("add")) {
			try {
				if (accountUtil.InsertDoctor(doctor)) {
					Message = "AddSuccess";
				}
		...
		response.sendRedirect("doctors.jsp?message=" + Message);
		return;
	}
